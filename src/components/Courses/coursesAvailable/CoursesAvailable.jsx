...
const CoursesAvailable = () => {
  ...
  return (
    <div className="generalContainerCoursesAvailable">
      <div className="contaryWrapperCoursesAvailable">
        {allCountries.map((contData, index) => (
          <div key={index} className="countryCardCoursesAvailable">
            <img src={contData.countryImage} alt="logo" />
